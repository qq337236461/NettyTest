				...
				<ul class="address">
								<li>
									<ul class="agileits-address-text ">
										<li class="agile-it-adress-left"><b>账户余额</b></li>
										<li><span>:</span>${user.account}</li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li class="agile-it-adress-left"><b>联系电话</b></li>
										<li><span>:</span>${user.phone}</li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li class="agile-it-adress-left"><b>年龄</b></li>
										<li><span>:</span>${user.age}</li>
									</ul>
								</li>
								<li>
									<ul class="agileits-address-text">
										<li class="agile-it-adress-left"><b>性别</b></li>
										<li><span>:</span>${user.sex}</li>
									</ul>
								</li>
							</ul> 
			...
			<div class="w3ls_footer_grids">
				...
				<div class="w3ls_footer_grid">
					...
					<div class="col-md-4 w3ls_footer_grid_left">
						...
						<div class="w3ls_footer_grid_leftr">
							<h4>Email</h4>
							<a href="mailto:info@example.com">jnscz666@163.com</a>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-4 w3ls_footer_grid_left">
